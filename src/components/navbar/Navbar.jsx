      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[9999] bg-[#fffcf9] md:hidden flex flex-col p-8"
          >
              ...
              <AnimatePresence>
                {searchQuery.trim() !== "" && (
                  <motion.div
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 space-y-3 bg-white/50 rounded-2xl p-2"
                  >
                    {searchResults.length > 0 ? (
                      searchResults.map((product) => (
                        <div 
                          ...
                          className="flex items-center gap-4 p-3 bg-white rounded-xl shadow-sm border border-rose-50"
                        >
